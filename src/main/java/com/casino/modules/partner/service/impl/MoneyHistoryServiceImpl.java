...
public class MoneyHistoryServiceImpl extends ServiceImpl<MoneyHistoryMapper, MoneyHistory> implements IMoneyHistoryService {
	...
	@Override
	public IPage<MoneyHistory> getMonthDepositLogByMemberSeq(Page<MoneyHistory> page, MoneyHistory moneyHistory,
			String memberSeq, Integer operationType, String column, Integer order) {
		return moneyHistoryMapper.getMonthDepositLogByMemberSeq(page, moneyHistory, memberSeq, operationType, column, order);
	}
